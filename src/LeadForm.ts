...
function onLoad(context: Xrm.Events.EventContext) {
    ...
    */
    ...
    // Test Enums
    console.log("Process Status Enum (Original): " + XrmEnum.ProcessStatus.Finished); // this will return lowercase and is not changed (currently) in the PR
    ...
    */
    console.log("EventArgsEnumStatus: " + XrmEnum.EventArgsStatus.ProcessStatus.Active); // should return "Active"
    console.log("FormContextEnumStatus: " + XrmEnum.FormContextStatus.ProcessStatus.Active); // should return "active"
}
function onPreProcessStatusChange(context: Xrm.Events.ProcessStatusChangedEventContext) {
    ...
    */
    ...
    else console.log("Match unsuccessful");
...
function onProcessStatusChange(context: Xrm.Events.ProcessStatusChangedEventContext) {
    console.log("Running onPreProcessingStatusChange event handler");
    /* This transpiles directly to context.getEventArgs().getStatus() and will return A Pascal case status e.g. Active */
    console.log("GetEventArgs Status: " + context.getEventArgs().getStatus());
    const receivedStatus = context.getEventArgs().getStatus();
...
function onStageSelected(context: Xrm.Events.StageSelectedEventContext) { // occurs when stage is clicked
